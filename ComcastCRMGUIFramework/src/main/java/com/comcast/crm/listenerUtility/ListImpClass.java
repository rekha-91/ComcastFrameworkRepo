...
public class ListImpClass implements ITestListener, ISuiteListener
{
	...
	public void onTestFailure(ITestResult result)
	{
		...
		//EventFiringWebDriver edriver= new EventFiringWebDriver(driver); //depreciated method
		String timeStamp= new Date().toString().replace(' ', '_').replace(':', '_');
		...
		/*try {
			FileUtils.copyFile(srcFile, new File("./Screeshot/"+testName+"/"+timeStamp+".png"));
		} catch (IOException e) {
			
			e.printStackTrace();
		}*/  //no need in extent report
